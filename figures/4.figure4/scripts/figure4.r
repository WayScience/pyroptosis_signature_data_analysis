...
IL1beta_a_v_p <- pred_v_actual_plot(df_stats, "IL-1beta") + ggplot2::coord_fixed(ratio=1)
TNFalpha_a_v_p <- pred_v_actual_plot(df_stats, "TFalpha") + ggplot2::coord_fixed(ratio=1)
