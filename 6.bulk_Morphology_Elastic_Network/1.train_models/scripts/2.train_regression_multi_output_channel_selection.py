...
if shuffle == "shuffled_baseline":
    dump(
        model,
        f"{results_dir}/{cytokine}_{data_group}_shuffled_baseline__all_nomic.joblib",
    )
elif shuffle == "final":
    dump(
        model,
        f"{results_dir}/{cytokine}_{data_group}_final__all_nomic.joblib",
    )
else:
    print("Error")
...
if shuffle == "shuffled_baseline":
    config_copy_path = pathlib.Path(
        f"{results_dir}/{cytokine}_{data_group}_shuffled_baseline__all_nomic.toml"
    )
elif shuffle == "final":
    config_copy_path = pathlib.Path(
        f"{results_dir}/{cytokine}_{data_group}_final__all_nomic.toml"
    )
else:
    print("Error")
