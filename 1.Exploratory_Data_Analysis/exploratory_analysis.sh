...
papermill 4.cell_count_analysis.ipynb 0.cell_count_analysis.ipynb -p celltype "SHSY5Y"

papermill 1.umap_analysis_plate2.ipynb 1.umap_analysis_plate2.ipynb -p celltype "PBMC"
papermill 4.cell_count_analysis.ipynb 0.cell_count_analysis.ipynb -p celltype "PBMC"
